      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="text-sm text-neutral-400 mt-2">
            Source: <a href="https://x.com/0xCygaar/status/1874575841763770492" className="text-neutral-400 hover:text-neutral-300">https://x.com/0xCygaar/status/1874575841763770492</a>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          >
            <div className="relative overflow-hidden rounded-lg bg-[var(--black)]/50 p-6 h-64 flex items-center justify-center">
              <div className="absolute inset-0 bg-gradient-to-br from-neutral-500/10 to-neutral-500/10"></div>
