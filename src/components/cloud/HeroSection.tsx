...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-neutral-800/20 via-neutral-900/20 to-black opacity-40"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <Button 
            variant="outline"
            size="lg" 
            className="text-lg px-8 text-[var(--white)] border-neutral-500/30 hover:bg-neutral-800/20"
          >
