    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3">
        {aiModels.map((model) => (
          <motion.div
            key={model.id}
            className={`p-3 rounded-lg border ${selectedModel === model.id ? "bg-neutral-800/20 border-neutral-600/40" : "bg-gray-800/40 border-gray-700/40"} hover:bg-gray-800/60 transition-colors cursor-pointer`}
