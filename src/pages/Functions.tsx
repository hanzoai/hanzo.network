      ...
      <section className="py-20 lg:py-32 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="bg-neutral-600/10 border border-neutral-500/20 rounded-full px-4 py-1 inline-block mb-4">
          ...
          <div className="relative bg-neutral-800/20 border border-neutral-500/20 rounded-xl p-8 overflow-hidden">
            ...
            <pre className="text-sm sm:text-base overflow-x-auto bg-[var(--black)]/50 p-4 rounded-lg border border-neutral-500/30">
              <code className="text-neutral-300">
                <span className="text-neutral-400">export</span> <span className="text-neutral-400">async function</span> <span className="text-neutral-400">handler</span><span className="text-[var(--white)]">(req, res) {'{'}</span>
                <br/>
                ...
                <br/>
                <span className="ml-8">success: <span className="text-neutral-400">true</span>,</span>
                <br/>
